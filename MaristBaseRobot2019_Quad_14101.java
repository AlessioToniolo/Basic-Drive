 ...
 *
 * Motor channel: leftFront:        "leftfront"  port0 Rev2
 * Motor channel: rightFront:       "rightfront" port2 Rev2
 * Motor channel: leftRear:          "leftrear"  port1 Rev2
 * Motor channel: rightRear:         "rightrear"  port3 Rev2
 * Motor channel: liftMotor:         "liftmotor" port0 Rev3
 * Motor channel: leftArm:           "leftarm"   port1 Rev3
 * Motor channel: rightArm:          "rightarm"  port2 Rev3
 * Servo Channel: leftHand:          "lefthand"   servo0 Rev2
 * Servo Channel: foundationR:       "foundationR"  servo1 Rev2
 * Servo Channel: foundationL:       "foundationL" servo2 Rev2
 */

public class MaristBaseRobot2019_Quad_14101 {
    ...
    public Servo capstoneBase = null;
    ...
    public void init(HardwareMap ahwMap) {
        ...
        foundationR = hwMap.servo.get("foundationR");
        foundationL = hwMap.servo.get("foundationL");
        capstoneBase = hwMap.servo.get("capstoneBase");
        capstoneArm = hwMap.servo.get("capstoneArm");
        
        //leftHand.setPosition(MID_SERVO);
        foundationR.setPosition(0.0);
        foundationL.setPosition(1.0);
        leftClaw.setPosition(0.27);
        rightClaw.setPosition(0.9);
        
        capstoneBase.setPosition(0.0); // Starting Position: Need to adjust
        capstoneArm.setPosition(0.2);  // Starting Position: Need to adjust
    ...
    public void pointTurnDegrees(double speed,
        ...
        deg = deg * 2.7;  // Adjust for robot orientation
