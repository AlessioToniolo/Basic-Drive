...
@TeleOp(name="MaristBot2019: Teleop Quad 2019", group="Training")
//@Disabled
public class TeleopTank_Quad_2019 extends OpMode {

    /* Declare OpMode members. */
    MaristBaseRobot2019_Quad robot   = new MaristBaseRobot2019_Quad(); // use the class created to define a Robot's hardware
    ...
    public void loop() {
        ...
        */
        ...
        // Mechanum Basic Drive
        left = gamepad1.left_stick_y;
        right = gamepad1.right_stick_y;
        robot.leftFront.setPower(left-gamepad1.left_stick_x-gamepad1.right_stick_x);
        robot.rightFront.setPower(left+gamepad1.left_stick_x+gamepad1.right_stick_x);
        robot.leftRear.setPower(left+gamepad1.left_stick_x-gamepad1.right_stick_x);
        robot.rightRear.setPower(left-gamepad1.left_stick_x+gamepad1.right_stick_x);
        ...
        */
        ...
        // Limit Power to -0.7 to 0.7
        if (armMotorPower > 0.7) {
            armMotorPower = 0.7;
        }
